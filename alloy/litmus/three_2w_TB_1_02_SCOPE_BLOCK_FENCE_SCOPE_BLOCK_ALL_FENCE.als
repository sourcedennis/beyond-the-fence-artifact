// Litmus: three_2w_TB_1_02_SCOPE_BLOCK_FENCE_SCOPE_BLOCK_ALL_FENCE
// Expected: ?
module litmus
open ptx as ptx
pred generated_litmus_test {
  ...
  some
    ...
    f3.scope = System and
    r1.scope = System and
    t0 in w4.scope.*subscope and
    t1 not in w4.scope.*subscope and
    t2 in w4.scope.*subscope and
    t0 in f4.scope.*subscope and
    t1 not in f4.scope.*subscope and
    t2 in f4.scope.*subscope and
    t0 in w5.scope.*subscope and
